...
SRS_ADMIN_API_CONTAINER_BUILD="$SRC_DIR/Admin/VMware.ScriptRuntimeService.AdminWebApi/docker/build.sh"
...
echo "INFO: Build Srs Admin Api Container '$SRS_ADMIN_API_CONTAINER_BUILD'"
$SRS_ADMIN_API_CONTAINER_BUILD $ADMIN_API_IMAGE_NAME $DOTNET_COMMAND $DOCKER_COMMAND $CONTAINER_VERSION_LABEL
...
if test -f "$CONTAINERS_EXPORT_DIR/$ADMIN_API_IMAGE_NAME-$IMAGE_EXPORT_FILE"; then
	rm -f $CONTAINERS_EXPORT_DIR/$ADMIN_API_IMAGE_NAME-$IMAGE_EXPORT_FILE$
fi
...
$DOCKER_COMMAND save -o "$CONTAINERS_EXPORT_DIR/$ADMIN_API_IMAGE_NAME-$IMAGE_EXPORT_FILE" $ADMIN_API_IMAGE_NAME:$CONTAINER_VERSION_LABEL
