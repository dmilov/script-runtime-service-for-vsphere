...
namespace VMware.ScriptRuntimeService.AdminWebUI.Controllers
{
   [ApiController]
   [Route("[controller]")]
   public class ServerCertificateController : ControllerBase
   {
      private readonly ILogger<ServerCertificateController> _logger;

      public ServerCertificateController(ILogger<ServerCertificateController> logger)
      {
         _logger = logger;
      }
      ...
      public JsonResult Get([FromQuery] string serverAddress)
      {
